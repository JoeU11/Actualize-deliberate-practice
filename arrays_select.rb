...
# array3 = array.select { |num| num < 20}
# p array3
...
# p array.select { |word| word[0].downcase == "w"}
...
# p array.select { |item| item[:price] > 5}
...
# p array.select { |string| string.length < 4}
...
# p array.select { |item| item[:name].length < 6}
...
# p array.select { |item| item[:price] < 10}
